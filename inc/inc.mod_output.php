...
$_AS['val_uni1'] = urldecode($_AS['cms_wr']->getVal($_AS['modkey'].'uni1'));
$_AS['val_uni2'] = urldecode($_AS['cms_wr']->getVal($_AS['modkey'].'uni2'));
$_AS['val_uni3'] = urldecode($_AS['cms_wr']->getVal($_AS['modkey'].'uni3'));
$_AS['val_uni_urlencode1'] = urlencode(urldecode($_AS['cms_wr']->getVal($_AS['modkey'].'uni1')));
$_AS['val_uni_urlencode2'] = urlencode(urldecode($_AS['cms_wr']->getVal($_AS['modkey'].'uni2')));
$_AS['val_uni_urlencode3'] = urlencode(urldecode($_AS['cms_wr']->getVal($_AS['modkey'].'uni3')));
...
//
// check used customs and build array
//
$_AS['temp']['active_customs']=array();
for ($i=1;$i<51;$i++){
		$_AS['temp']['customs_label']=trim($_AS['artsys_obj']->getSetting('article_custom'.$i.'_label'));
		if (!empty($_AS['temp']['customs_label']))
			$_AS['temp']['active_customs'][]=$i;
}
...
foreach ($_AS['temp']['active_customs'] as $i)
	if ($i>9)
...
if (strpos($mvars[5],'{set_category_form}')!==false) {
	$_AS['temp']['temp_setcategory']=$_AS['cms_wr']->getVal($_AS['modkey'].'setcategory');
	if (is_array($_AS['temp']['temp_setcategory']))
		$_AS['temp']['setcategory']=implode(',',$_AS['temp']['temp_setcategory']);
	else
		$_AS['temp']['setcategory']=$_AS['temp']['temp_setcategory'];
...
if (strpos($mvars[5],'{category_form}')!==false) {
	$_AS['temp']['temp_category_recheck']=$_AS['cms_wr']->getVal($_AS['modkey'].'category');
	if (is_array($_AS['temp']['temp_category_recheck']))
		$_AS['temp']['category_recheck']=implode(',',$_AS['temp']['temp_category_recheck']);
	else
		$_AS['temp']['category_recheck']=$_AS['temp']['temp_category_recheck'];
...
if ($mvars['74']=='teaser' && !$_AS['idarticle']) {
  ...
  $_AS['collection'] = new ArticleCollection();
	...
	if ($mvars['74101']=='idcatside' || empty($mvars['74101']))
	  $_AS['collection']->setSearchString($cms_url_side_addon.$idcatside.$cms_url_cr_addon,explode(',',$mvars['74001']),$exact_search);
			
	if ($mvars['74101']=='idcat')
	  $_AS['collection']->setSearchString($cms_url_cat_addon.$idcat.$cms_url_cr_addon,explode(',',$mvars['74001']),$exact_search);
				
	if ($mvars['74101']=='idcat_r') {
		$_AS['temp']['tm_idcatparents']=as_get_idcat_parent_cats($idcat,$lang,$client);
	  $_AS['collection']->setSearchString($cms_url_cat_addon.implode($cms_url_cr_addon.' '.$cms_url_cat_addon,$_AS['temp']['tm_idcatparents']).$cms_url_cr_addon,explode(',',$mvars['74001']),$exact_search);
	}
	...
	if ($_AS['collection']->countitems()>=1) {
	  ...
	  for($iter = $_AS['collection']->get(); $iter->valid(); $iter->next() ) {
			...
			foreach (explode(',',$mvars['74001']) as $cfields) {
			
				$_AS['temp']['cf_value_arr']=explode("\n",trim($_AS['item']->getDataByKey($cfields)));
  ...
  //Url
	...
	$_AS['temp']['data']['url_back'] = as_url_creator ( $con_side[(empty($_AS['temp']['idcatsideback'])?$idcatside:$_AS['temp']['idcatsideback'])]['link'],
																							array (	'startmonth' => $_AS['config']['startmonth'],
																											...
																											'cf36' => $_AS['temp']['customfilters2']['custom36'],
																											'cf37' => $_AS['temp']['customfilters2']['custom37'],
																											'cf38' => $_AS['temp']['customfilters2']['custom38'],
																											'cf39' => $_AS['temp']['customfilters2']['custom39'],
																											'cf40' => $_AS['temp']['customfilters2']['custom40'],	
																											'cf41' => $_AS['temp']['customfilters2']['custom41'],
																											'cf42' => $_AS['temp']['customfilters2']['custom42'],
																											'cf43' => $_AS['temp']['customfilters2']['custom43'],
																											'cf44' => $_AS['temp']['customfilters2']['custom44'],
																											'cf45' => $_AS['temp']['customfilters2']['custom45'],
																											'cf46' => $_AS['temp']['customfilters2']['custom46'],
																											'cf47' => $_AS['temp']['customfilters2']['custom47'],
																											'cf48' => $_AS['temp']['customfilters2']['custom48'],
																											'cf49' => $_AS['temp']['customfilters2']['custom49'],
																											'cf50' => $_AS['temp']['customfilters2']['custom50'],	
  ...
  if(($_AS['item']->available() ||  $mvars['73']=='true') && (int) $_AS['item']->_data['online']>0  ) {
	...
	#			'limit_latest' => (int) $mvars['400027'],//kann wegfallen
  	...
  	// global if-statements
		...
		$_AS['temp']['detail'] = str_replace('{idcatside_url}',$con_side[$idcatside]['link'],$_AS['temp']['detail']);

		$_AS['temp']['detail'] =str_replace('{uni:1}',$_AS['val_uni1'],as_element_ifstatements($_AS['temp']['detail'] ,array('uni:1' => $_AS['val_uni1']),'uni:1',$_AS['val_uni1']));
		$_AS['temp']['detail'] =str_replace('{uni:2}',$_AS['val_uni2'],as_element_ifstatements($_AS['temp']['detail'] ,array('uni:2' => $_AS['val_uni2']),'uni:2',$_AS['val_uni2']));
		$_AS['temp']['detail'] =str_replace('{uni:3}',$_AS['val_uni3'],as_element_ifstatements($_AS['temp']['detail'] ,array('uni:3' => $_AS['val_uni3']),'uni:3',$_AS['val_uni3']));

		$_AS['temp']['detail'] =str_replace('{uni_urlencode:1}',$_AS['val_uni_urlencode1'],$_AS['temp']['detail']);
		$_AS['temp']['detail'] =str_replace('{uni_urlencode:2}',$_AS['val_uni_urlencode2'],$_AS['temp']['detail']);
		$_AS['temp']['detail'] =str_replace('{uni_urlencode:3}',$_AS['val_uni_urlencode3'],$_AS['temp']['detail']);

		$_AS['temp']['detail'] = str_replace('{idlang}',$idlang,$_AS['temp']['detail']);
		$_AS['temp']['detail'] = str_replace('{idcatside}',$idcatside,$_AS['temp']['detail']);
		$_AS['temp']['detail'] = str_replace('{idcat}',$idcatside,$_AS['temp']['detail']);
...
#			}			
  ...
  //Für jeden geladenenen Eintrag durchlaufen
	...
	$_AS['temp']['if_change_elements'] = array();
	$_AS['temp']['if_change_mem'] = array();
	preg_match_all('/\{if_change_(.*?)\}/',$mvars[6],$_AS['temp']['if_change_a']);	
	preg_match_all('/\{if_not_change_(.*?)\}/',$mvars[6],$_AS['temp']['if_change_b']);
	$_AS['temp']['if_change_elements']=array_merge($_AS['temp']['if_change_a'][1],$_AS['temp']['if_change_b'][1]);
...
#				$_AS['temp']['data']['comments'] = $_AS['temp']['sf_comments']->getComments($_AS['temp']['comments_config']);
        ...
        if ($k=='category')
          if ($v!=$v_mem || $ic==0){
				...
				//if change
				if (count($_AS['temp']['if_change_elements'])>0) 
					if (in_array($k,$_AS['temp']['if_change_elements'])) {
					
						if(strpos($_AS['temp']['list_output'],'{if_change_'.$k)!==false)
							if ($_AS['temp']['if_change_mem'][$k]==$v)
								$_AS['temp']['list_output'] = preg_replace('#\{if_change_'.$k.'\}(.*)\{/if_change_'.$k.'\}#sU','',$_AS['temp']['list_output']);
							else
								$_AS['temp']['list_output'] = str_replace(array('{if_change_'.$k.'}','{/if_change_'.$k.'}'), array('',''), $_AS['temp']['list_output']);
		
						if(strpos($_AS['temp']['list_output'],'{if_not_change_'.$k)!==false)
							if ($_AS['temp']['if_change_mem'][$k]==$v)
								$_AS['temp']['list_output'] = str_replace(array('{if_not_change_'.$k.'}','{/if_not_change_'.$k.'}'), array('',''), $_AS['temp']['list_output']);
							else
								$_AS['temp']['list_output'] = preg_replace('#\{if_not_change_'.$k.'\}(.*)\{/if_not_change_'.$k.'\}#sU','',$_AS['temp']['list_output']);
	
						//memorize
						$_AS['temp']['if_change_mem'][$k]=$v;
...
//
	...
	foreach ($_AS['temp']['active_customs'] as $i) {
		...
		$_AS['output']['list_body'] = str_replace('{'.$k.'}',
																							...
																							'" '.((substr($_AS['temp']['sortlinkvalsold'][$v],4,1)=='A')?$mvars[781]:$mvars[780]).'>',
																							$_AS['output']['list_body']);
		$_AS['output']['list_body'] = str_replace('{/'.$k.'}','</a>',$_AS['output']['list_body']);
	}	
...
//			if (array_key_exists(date('Y',  mktime(0,0,0,$_AS['temp']['startmonth']+1)),$_AS['temp']['mselect']['avail']))
	...
	if (strpos($_AS['output']['list_body'],'category_form}')!==false){
		...
		// start & end
		$_AS['temp']['setcategoryselect']['html']['form_start']	= '<form method="post" name="'.
																														$_AS['modkey'].'category" action="'.
																														as_url_creator( $con_side[$idcatside]['link'],
																																						array('idarticle' => (($mvars['72']=='list')?$_AS['idarticlemem']:''),
																																									'idcatsideback' => (($mvars['72']=='list' && !empty($_AS['temp']['idcatsideback']))?$_AS['temp']['idcatsideback']:''),
		...
		if (strpos($mvars[103019],'multiple')!==false)
			$ffaddon='[]';

		$_AS['temp']['categoryselect']['html']['form_select'][] =	'<select name="'.$_AS['modkey'].'category'.$ffaddon.'" id="'.$_AS['modkey'].'category" size="1" '.str_replace('{form_name}',$_AS['modkey'].'category',$mvars[103019]).'>';
		...
		if (is_array($_AS['temp']['categories']))
			foreach ( $_AS['temp']['categories'] as $k => $v) {
				...
				$_AS['temp']['setcategoryselect']['html']['form_select'][]	=	'<option value="'. $k .'" '.
																																			((in_array($k,explode(',',$_AS['temp']['category_mem']))) ? 'selected="selected"':'').
																																			'>'.
																																			htmlentities($v, ENT_COMPAT, 'UTF-8').
																																			'</option>'."\n";
		}
	  ...
	  $_AS['temp']['categoryselect']['html']['form_submit'] = '<input type="submit" value="'.$mvars[105019].'" '.str_replace('{form_name}',$_AS['modkey'].'category',$mvars[107019]).' />';
		...
		// complete html
		$_AS['temp']['setcategoryselect']['html']['complete'] = $_AS['temp']['setcategoryselect']['html']['form_start'].
																									  	str_replace(
																									  			array(
																									          '{category_select}',
																									          '{category_label}',
	...
	if (strpos($_AS['output']['list_body'],'{category_links}')!==false){
		...
		if (is_array($_AS['temp']['categories'])){
			...
			$mvars[102019]=trim($mvars[102019]);
			if (!empty($mvars[102019]))
...
if(!class_exists('AS_Calendar')) {
	...
	$_AS['output']['list_body'] = str_replace('{uni:1}',$_AS['val_uni1'],as_element_ifstatements($_AS['output']['list_body'],array('uni:1' => $_AS['val_uni1']),'uni:1',$_AS['val_uni1']));
	$_AS['output']['list_body'] = str_replace('{uni:2}',$_AS['val_uni2'],as_element_ifstatements($_AS['output']['list_body'],array('uni:2' => $_AS['val_uni2']),'uni:2',$_AS['val_uni2']));
	$_AS['output']['list_body'] = str_replace('{uni:3}',$_AS['val_uni3'],as_element_ifstatements($_AS['output']['list_body'],array('uni:3' => $_AS['val_uni3']),'uni:3',$_AS['val_uni3']));

	$_AS['output']['list_body'] = str_replace('{uni_urlencode:1}',$_AS['val_uni_urlencode1'],$_AS['output']['list_body']);
	$_AS['output']['list_body'] = str_replace('{uni_urlencode:2}',$_AS['val_uni_urlencode2'],$_AS['output']['list_body']);
	$_AS['output']['list_body'] = str_replace('{uni_urlencode:2}',$_AS['val_uni_urlencode3'],$_AS['output']['list_body']);

	$_AS['output']['list_body'] = str_replace('{idlang}',$idlang,$_AS['output']['list_body']);
	$_AS['output']['list_body'] = str_replace('{idcatside}',$idcatside,$_AS['output']['list_body']);
	$_AS['output']['list_body'] = str_replace('{idcat}',$idcatside,$_AS['output']['list_body']);

	
	$_AS['output']['list_body'] = str_replace('{idcatside_url}',$con_side[$idcatside]['link'],$_AS['output']['list_body']);
	$_AS['output']['list_body'] = str_replace('{idcatside_page_url}',as_url_creator( $con_side[$idcatside]['link'],array( 'page' => $_AS['page_nav_current_page'])),$_AS['output']['list_body']);
