...
if(! defined('CMS_CONFIGFILE_INCLUDED')){
    ...
    $defaultsettings['spfnc_facebook_from'] = '';
    $defaultsettings['spfnc_facebook_to'] = '';
...
#    $defaultsettings['spfnc_facebook_tpl_dates'] = '{date} - {datetime24} - {datetitle}';
    ...
    $defaultsettings['spfnc_facebook_picture'] = '';
    ...
    $defaultsettings['spfnc_facebook_lastsent_postid_cf'] = '';
