...
if($_AS['item']->getDataByKey('key2') == 'spfnc_facebook_from') {
	...
	$_AS['output']['temp2'][116] = str_replace(array(
				'{lng_uni}',
				'{uni_input_name}',
				'{uni_input_value}'
		),
...
if($_AS['item']->getDataByKey('key2') == 'spfnc_facebook_to') {
	...
	$_AS['output']['temp2'][117] = str_replace(array(
				'{lng_uni}',
				'{uni_input_name}',
				'{uni_input_value}'
		),
...
if($_AS['item']->getDataByKey('key2') == 'spfnc_facebook_lastsent_postid_cf') {
...
if($_AS['item']->getDataByKey('key2') == 'spfnc_facebook_picture') {
	...
	$_AS['output']['temp2'][190] = str_replace(array(
				'{lng_uni}',
				'{select_uni}'
		),
		array(
...
if($_AS['item']->getDataByKey('key2') == 'spfnc_facebook_media') {
	...
	$_AS['output']['temp2'][195] = str_replace(array(
				'{lng_uni}',
				'{select_uni}'
		),
		array(
