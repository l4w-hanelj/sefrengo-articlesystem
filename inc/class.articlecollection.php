...
#          	echo "<pre>".$sql."</pre>";
            ...
            while (!$rs->EOF) {
                ...
                $_data = array(
                    ...
                    'custom36' => $rs->fields['custom36'],
                    'custom37' => $rs->fields['custom37'],
                    'custom38' => $rs->fields['custom38'],
                    'custom39' => $rs->fields['custom39'],
                    'custom40' => $rs->fields['custom40'],
                    'custom41' => $rs->fields['custom41'],
                    'custom42' => $rs->fields['custom42'],
                    'custom43' => $rs->fields['custom43'],
                    'custom44' => $rs->fields['custom44'],
                    'custom45' => $rs->fields['custom45'],
                    'custom46' => $rs->fields['custom46'],
                    'custom47' => $rs->fields['custom47'],
                    'custom48' => $rs->fields['custom48'],
                    'custom49' => $rs->fields['custom49'],
                    'custom50' => $rs->fields['custom50'],
    ...
    function delete() {
        ...
        $langcopy=$_AS['article_obj']->getSetting('new_articles_lang_copy');
       		...
       		$langs=$_AS['article_obj']->getClientLangs();	
					...
					if (( $_AS['article_obj']->getSetting('del_all_lang_copies')=='true' || count($langs)<2 ) && trim($this->_data['hash'])!='') {
