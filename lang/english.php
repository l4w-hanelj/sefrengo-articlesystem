...
$plug_lang['settings_lv_customfilter'] = 'Free definable fields filter in article\'s overview <br/><small><strong>DATA FIELD(S) one below the order</strong><br/><br/>custom1-50</small>';
...
$plug_lang['settings_lv_sorting'] = 'Sorting of the article fields in the overview<br/><small><strong>DATA FIELD </strong>(see below) > <strong>SORTING</strong> (ASC = ascending, DESC = descending)<br/><br/>startdate starttime enddate endtime created lastedit title teaser text custom1-50</small>';
$plug_lang['settings_lv_fields'] = 'Article fields to show in the overview <br/><small><strong>DATA FIELD(S) one below the order</strong><br/><br/>title teaser text custom1-50 editor</small>';

$plug_lang['settings_backend_menu_string'] = 'Title for Sefrengo\'s backend menu item';

for ($i=1;$i<51;$i++){
	$plug_lang['article_settings_custom'.$i] =  'Free definable field '.str_pad($i, 2 ,'0', STR_PAD_LEFT);
	$plug_lang['article_custom'.$i] =  'Free def. field '.str_pad($i, 2 ,'0', STR_PAD_LEFT);
}
