...
$plug_lang['settings_lv_customfilter'] = 'Freifeldfilter in der Artikelübersicht <br/><small><strong>DATENFELD(ER) untereinander eingeben</strong><br/><br/>custom1-50</small>';
...
$plug_lang['settings_lv_sorting'] = 'Sortierung der Artikelübersicht<br/><small><strong>DATENFELD </strong>(s.u.) > <strong>SORTIERUNG</strong> (ASC = aufsteigend, DESC = Absteigend)<br/><br/>startdate starttime enddate endtime created lastedit title teaser text custom1-50</small>';
$plug_lang['settings_lv_fields'] = 'Anzuzeigende Felder in der Artikelübersicht <br/><small><strong>DATENFELD(ER) untereinander eingeben</strong><br/>Optional Angabe der Spaltenbreite (in Prozent) möglich: DATENFELD||BREITE<br/><br/>title teaser text custom1-50 editor</small>';

$plug_lang['settings_backend_menu_string'] = 'Bezeichnung für Sefrengo-Backend-Menüeintrag';

for ($i=1;$i<51;$i++){
	$plug_lang['article_settings_custom'.$i] =  'Frei definierbares Feld '.str_pad($i, 2 ,'0', STR_PAD_LEFT);
	$plug_lang['article_custom'.$i] =  'Freifeld '.str_pad($i, 2 ,'0', STR_PAD_LEFT);
}
...
$plug_lang['article_value_missing'] =  'Angabe fehlt';
...
$plug_lang['spfnc_facebook_section'] = 'facebook-Link-Veröffentlichung';
$plug_lang['spfnc_facebook_manualsentconfirm'] = 'Erfolgreich veröffentlicht?';
$plug_lang['spfnc_facebook'] = 'Funktionalität aktivieren';
$plug_lang['spfnc_facebook_from'] = 'Absender <small>(facebook-User/Page-ID) <strong>optional</strong></small>';
$plug_lang['spfnc_facebook_to'] = 'Empfänger <small>(facebook-User/Page-ID) <strong>optional</strong></small>';
$plug_lang['spfnc_facebook_app_key'] = 'Anwendungs-ID/API-Schlüssel <small>(Neue Anwendung <a href="http://developers.facebook.com/apps" onclick="void(window.open(this.href, \'\', \'\')); return false;">hier</a> erstellen!)</small>';
...
$plug_lang['spfnc_facebook_lastsent_date_cf'] = 'Freidef. Feld zur Speicherung der letzen Veröffentlichungszeit <small><br/>(vom Typ "Datum+Zeit") <strong>optional</strong></small> ';
$plug_lang['spfnc_facebook_lastsent_postid_cf'] = 'Freidef. Feld zur Speicherung der facebook-Post-ID<small><br/>(vom Typ "Einz. Textfeld") <strong>optional</strong></small> ';
$plug_lang['spfnc_facebook_url'] = 'Link zum Artikel - URL-Template<br/><small>Mögliche Elemente: {baseurl}, {idlang}, {idarticle}, {idcategory}</small>';
$plug_lang['spfnc_facebook_url_name'] = 'Link zum Artikel - Link-Titel<small><br/>(Titel-Feld o. Freidef. Feld vom Typ "Einz. Textfeld")</small> ';
$plug_lang['spfnc_facebook_url_caption'] = 'Link um Artikel - Link-Beschreibung <small><br/>(Aufmacher-Feld o. Freidef. Feld vom Typ "Einz. Textfeld" o. "Mehrz. Textfeld")</small> ' ;
$plug_lang['spfnc_facebook_url_man'] = 'Link zu einer beliebigen Seite - URL <small>(Freidef. Feld vom Typ "Link")<br/>Wird eine beliebige Seite gewählt, wird keine Link-URL zum Artikel generiert.<br/>Auch werden die Link-Titel- und ggf. Link-Beschreibungsangaben des Freidef. Feldes <br/>(vom Typ "Link") anstelle der artikel-link-bezogenen Angaben verwendet. <strong>optional</strong></small>';
$plug_lang['spfnc_facebook_picture'] = 'Vorschaubild - Freidef. Feld <small>(vom Typ "Bild") <strong>optional</strong></small>';
$plug_lang['spfnc_facebook_media'] = 'Mediendatei - Freidef. Feld <small>(vom Typ "Bild" o. "Datei") <strong>optional</strong></small>';
...
$plug_lang['spfnc_twitter_url'] = $plug_lang['spfnc_facebook_url'];
$plug_lang['spfnc_twitter_url_man'] = $plug_lang['spfnc_facebook_url_man'];
...
$plug_lang['spfnc_twitter_lastsent_date_cf'] =  'Freidef. Feld zur Speicherung der letzen Veröffentlichungszeit <small><br/>(vom Typ "Datum+Zeit")</small> ';
