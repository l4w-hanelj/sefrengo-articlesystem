...
if($is_dev)
	include $cfg_cms['cms_path'].'plugins/articlesystem/module/mod_input.php';
else {
...
$mip_form['10110']['desc'] = 'Liste - Tag<strong><small><br/>{startdate:day}  {enddate:day} {custom:<em>1-50</em>:day}</small></strong>';
...
$mip_form['10111']['desc'] = 'Liste - Monat<strong><small><br/>{startdate:month}  {enddate:month} {custom:<em>1-50</em>:month}</small></strong>';
...
$mip_form['10112']['desc'] = 'Liste - Jahr<strong><small><br/>{startdate:year}  {enddate:year}  {custom:<em>1-50</em>:year}</small></strong>';
...
$mip_form['10210']['desc'] = 'Detailansicht - Tag<strong><small><br/>{startdate:day}  {enddate:day} {custom:<em>1-50</em>:day}</small></strong>';
...
$mip_form['10211']['desc'] = 'Detailansicht - Monat<strong><small><br/>{startdate:month}  {enddate:month} {custom:<em>1-50</em>:month}</small></strong>';
...
$mip_form['10212']['desc'] = 'Detailansicht - Jahr<strong><small><br/>{startdate:year}  {enddate:year} {custom:<em>1-50</em>:year}</small></strong>';
...
$mip_form['11110']['desc'] = 'Liste - Tag<strong><small><br/>{startdate:day2}  {enddate:day2} {custom:<em>1-50</em>:day2}</small></strong>';
...
$mip_form['11111']['desc'] = 'Liste - Monat<strong><small><br/>{startdate:month2}  {enddate:month2} {custom:<em>1-50</em>:month2}</small></strong>';
...
$mip_form['11210']['desc'] = 'Detailansicht - Tag<strong><small><br/>{startdate:day2}  {enddate:day2} {custom:<em>1-50</em>:day2}</small></strong>';
...
$mip_form['11211']['desc'] = 'Detailansicht - Monat<strong><small><br/>{startdate:month2}  {enddate:month2} {custom:<em>1-50</em>:month2}</small></strong>';
...
{content}<br/>
{title_label} {teaser_label} {text_label} {category_label} {custom_label:<em>1-50</em>} {custom_selected:<em>1-50</em>}<br/>
...
{container_id} {mod_key} {idcatside_url} {idcatside_page_url}<br/>
<br/>
...
{year_form} {yearrange_form} {month_form} {customfilter_form:<em>1-50</em>} {customfilter_combinedform:<em>1</em>:<em>2</em>:<em>&nbsp;...&nbsp;</em>:<em>50</em>} {savesettings_form}</strong><br/>
{startdate_sortlink} {/startdate_sortlink}<br/>{enddate_sortlink} {/enddate_sortlink}<br/>{title_sortlink} {/title_sortlink}<br/>{teaser_sortlink} {/teaser_sortlink}<br/>{text_sortlink} {/text_sortlink}<br/>{custom_sortlink:<em>1-50</em>} {/custom_sortlink:<em>1-50</em>}<br/>
<br/>
<strong>Inhaltslogik/-manipulation</strong><br/>
{if_content} {/if_content}<br/>{if_backend} {/if_backend} {if_backend_edit} {/if_backend_edit} {if_backend_preview} {/if_backend_preview}
<br/>{if_frontend} {/if_frontend} {if_page_numbers} {/if_page_numbers}<br/>
{if_custom_selected:<em>1-50</em>} {/if_custom_selected:<em>1-50</em>}<br/>
...
{date:x} {datetitle:x} {datedesc:x} {dateduration:x} {datetime24:x} {datetime12:x}<br/>{date:x:day} {date:x:month} {date:x:day2} {date:x:month2} {date:x:year}<br/>
{custom:<em>1-50</em>} <span style="color:#555;">{custom_data:<em>1-50</em>}</span> {custom_label:<em>1-50</em>} {custom:<em>1-50</em>:date} {custom:<em>1-50</em>:time}<br/>{custom:<em>1-50</em>:day} {custom:<em>1-50</em>:month} {custom:<em>1-50</em>:year} {custom:<em>1-50</em>:timestamp}<br/>
{custom_<em>"image"-Elemente</em>:<em>1-50</em>} {custom_<em>"file"-Elemente</em>:<em>1-50</em>} {custom_<em>"link"-Elemente</em>:<em>1-50</em>}<br/>
<br/>
Spezielle "Custom-Link"-Elemente:<br/>{custom_linkidcat:<em>1-50</em>} {custom_linkidcatside:<em>1-50</em>}<br/>
{custom_linkidcat:<em>1-50</em>:idcat_si<em>1-3</em>} {custom_linkidcat:<em>1-50</em>:idcat_name_si<em>1-3</em>}<br/>
{custom_linkidcat:<em>1-50</em>:idcatside_si<em>1-3</em>} {custom_linkidcat:<em>1-50</em>:idcatside_name_si<em>1-3</em>}<br/>
{custom_linkidcat:<em>1-50</em>:side_links} {custom_linkidcat:<em>1-50</em>:cat_links}<br/>
<br/>
Alternativ für alle frei definierbaren Felder:<br/>{<em>Alias</em>} <span style="color:#555;">{<em>Alias</em>_data}</span> {<em>Alias</em>_label} {<em>Alias</em>:date} {<em>Alias</em>:time}<br/>{<em>Alias</em>:day} {<em>Alias</em>:month} {<em>Alias</em>:year} {<em>Alias</em>:timestamp}<br/>
{<em>Alias</em>_<em>"image"-Elemente</em>:<em>1-50</em>} {<em>Alias</em>_<em>"file"-Elemente</em>:<em>1-50</em>} {<em>Alias</em>_<em>"link"-Elemente</em>:<em>1-50</em>} <br/>
{<em>Alias</em>_linkidcat} {<em>Alias</em>_linkidcatside}<br/>
{<em>Alias</em>_linkidcat:idcat_si<em>1-3</em>} {<em>Alias</em>_linkidcat:idcat_name_si<em>1-3</em>}<br/>
{<em>Alias</em>_linkidcat:idcatside_si<em>1-3</em>} {<em>Alias</em>_linkidcat:idcatside_name_si<em>1-3</em>} <br/>
<br/>
...
{idarticle} {today_timestmap} {idcatside_url} {idcatside_page_url} {idlang} {container_id} {mod_key} {comments_count}<br/>
<br/>
<strong>Interaktion</strong><br/>{url} <em>(Detailansicht)</em><br/>
<br/>
<strong>Inhaltslogik/-manipulation</strong><br/>
{if_backend} {/if_backend} {if_backend_edit} {/if_backend_edit} {if_backend_preview} {/if_backend_preview} {if_frontend} {/if_frontend}<br/>
...
<strong>{if_change_</strong><em>Element:x</em><strong>} {/if_change_</strong><em>Element:x</em><strong>}</strong> <strong>{if_not_change_</strong><em>Element:x</em><strong>} {/if_not_change_</strong><em>Element:x</em><strong>}</strong><br/>
{hide_on_last_item} {/hide_on_last_item}
<br/>{chop} ... {/chop}</small></div>
...
$mip_form['74001']['type'] = '';
$mip_form['74001']['flag'] = 'multiple';
$mip_form['74001']['size'] = '7';
...
{starttime24} {starttime12} {endtime24} {endtime12}<br/>
<br/>
{idarticle} {today_timestmap} {idcatside_url} {idlang} {container_id} {mod_key} {comments_count}<br/>
<br/>
...
Mögliche Datenfelder: startdate starttime enddate endtime created lastedit title teaser text custom1-50</small>';
...
$mip_form['2900']['type'] = '';
$mip_form['2900']['desc'] = '<strong>{customfilter_form:1-50}</strong>';
...
$mip_form['780']['type'] = '';
$mip_form['780']['rows'] = '1';
$mip_form['780']['desc'] = '<strong>Sortierungs-Links <small>AUFSTEIGEND {<em>Element</em>_sortlink<em>(:1-50)</em>}</small></strong><br/>
...
$mip_form['781']['type'] = '';
$mip_form['781']['rows'] = '1';
$mip_form['781']['desc'] = '<strong>Sortierungs-Links <small>ABSTEIGEND {<em>Element</em>_sortlink<em>(:1-50)</em>}</small></strong><br/>
<small>Optionale Attribute</small>';
...
// Template Listenansicht - Zeile - Keinen Artikel gefunden
$mip_form['23']['desc'] = '<strong>Freifeldfilterauswahl <small>{customfilter_form:<em>1-50</em>}</small></strong>';
...
// Template Listenansicht - Zeile - Keinen Artikel gefunden
$mip_form['99023']['desc'] = '<strong>Freifeldfilterauswahl </strong>(kombiniert) <strong><small>{customfilter_combinedform:<em>1</em>:<em>2</em>:<em>&nbsp;...&nbsp;</em>:<em>50</em>}</small></strong>';
...
$mip_form['102023']['cat'] = 'txt';
$mip_form['102023']['type'] = '';
$mip_form['102023']['rows'] = '1';
$mip_form['102023']['desc'] = 'Beschriftung erster Selectbox-Eintrag <small>{custom_select}</small>';
$mip_form['102023']['cms_var'] = 'MOD_VAR[102023]';
$mip_form['102023']['cms_val'] = $cms_mod['value']['102023'];
$mip_form['102023']['cms_val_default'] = 'Auswählen';
...
$mip_form['hide_in_detail_output_mode'] = array(1000000,71,74001,74101,300,301,8,15,10015,16,90039,90040,39,40,41,42,43,44,4010,4011,
																								...
																								23,90023,99023,99923,105019,105023,101023,102023,103023,193023,104023,107023,199023,108023,
