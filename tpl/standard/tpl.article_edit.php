...
$_AS['tpl']['body'] = '
	...
	<script type="text/javascript" src="'.$cfg_client['htmlpath'].'cms/ckeditor/ckeditor.js"></script>
...
$_AS['tpl']['online'] = '
<tr id="row_online">
    <td class="head" width="150"><strong>{lng_online}</strong>&nbsp;</td>
...
<tr id="article_start">
    <td width="150" class="head"><strong>{lng_article_start}</strong>&nbsp;</td>
    <td >
      <table>
        <tr>
          <td width="160" nowrap>
            ...
            <div id="lay_article_start_day" style="display:inline"><input type="text" id="article_start_day" name="article[article_start_day]"  value="{day}" style="width:25px;text-align:center;">.</div>
            <div id="lay_article_start_month" style="display:inline"><input type="text" id="article_start_month" name="article[article_start_month]" value="{month}" style="width:25px;text-align:center;">.</div>
            <div id="lay_article_start_year" style="display:inline"><input type="text" id="article_start_year" name="article[article_start_year]" value="{year}" style="width:40px;text-align:center;">&nbsp;</div>
          ...
          <td nowrap style="padding-left:10px;">
            ...
            <div id="lay_article_start_hour" style="display:inline"><input type="text" id="article_start_hour" name="article[article_start_hour]" disabled="disabled" value="{hour}" style="width:25px;text-align:center;">:</div>
            <div id="lay_article_start_minute" style="display:inline"><input type="text" id="article_start_minute" name="article[article_start_minute]" disabled="disabled" value="{minute}" style="width:25px;text-align:center;"></div>
...
$_AS['tpl']['article_end'] = '
<tr id="article_end">
    <td width="150" class="head"><strong>{lng_article_end}</strong>&nbsp;</td>
    <td valign="top" >
      <table>
        <tr>
          <td width="160" nowrap>
            ...
            <div id="lay_article_end_day" style="display:inline"><input type="text" id="article_end_day" name="article[article_end_day]" value="{day}" disabled="disabled" style="width:25px;text-align:center;">.</div>
            <div id="lay_article_end_month" style="display:inline"><input type="text" id="article_end_month" name="article[article_end_month]" value="{month}" disabled="disabled" style="width:25px;text-align:center;">.</div>
            <div id="lay_article_end_year" style="display:inline"><input type="text" id="article_end_year" name="article[article_end_year]" value="{year}" disabled="disabled" style="width:40px;text-align:center;">&nbsp;</div>
          ...
          <td nowrap style="padding-left:10px;">
            ...
            <div id="lay_article_end_hour" style="display:inline"><input type="text" id="article_end_hour" name="article[article_end_hour]" disabled="disabled" value="{hour}" style="width:25px;text-align:center;">:</div>
            <div id="lay_article_end_minute" style="display:inline"><input type="text" id="article_end_minute" name="article[article_end_minute]" disabled="disabled" value="{minute}" style="width:25px;text-align:center;"></div>
                <script language="JavaScript" type="text/javascript">
...
$_AS['tpl']['category'] = '
<tr id="row_category">
    <td width="150" class="head"><strong>{lng_category}</strong>&nbsp;</td>
...
$_AS['tpl']['title'] = '
<tr id="row_title">
    <td width="150" class="head"><strong>{lng_title}</strong>&nbsp;</td>
    <td valign="top"><input type="text" class="w800" id="title" name="article[title]" value="{title}" ></td>
...
$_AS['tpl']['teaser'] = '
<tr id="row_teaser">
    <td width="150"  class="head" valign="top"><strong>{lng_teaser}</strong>&nbsp;</td>
    <td valign="top"><textarea id="teaser" name="article[teaser]" style="height:55px;" class="w800">{teaser}</textarea></td>
...
$_AS['tpl']['text'] = '
<tr id="row_text">
    <td width="150"  class="head" valign="top"><strong>{lng_text}</strong>&nbsp;</td>
    <td valign="top"><textarea  class="{tinymce_class}w800" id="text" name="article[text]"  rows="8">{text}</textarea></td>
...
$_AS['tpl']['organizer'] = '
<tr id="row_organizer">
    <td width="150" class="head"><strong>{lng_organizer}</strong>&nbsp;</td>
    		...
    		<table cellspacing="0" cellpadding="0" border="0" width="100%">
    			...
    			<tr>
    				<td style="padding-bottom:15px;">
    					<input type="text" style="width:350px" id="picture1_title{idelement}" name="artel[image][title][]" value="{picture1_title}" />
    					<span style="display:{showhide_desc}">
	    					<small style="display:block;padding:5px 0 2px 0">{lng_picture1_description}</small>
	    					<textarea style="width:350px;display:block;" id="picture1_desc{idelement}" name="artel[image][description][]" >{picture1_description}</textarea>
							</span>
    				</td>
    			</tr>    		
    		</table>
...
$_AS['tpl']['file1sub'] = '
    			...
    			<tr style="display:{showhide_upload}">
    				...
    				<td colspan="2">
    					<small style="display:block;padding:4px 0 2px 0">{lng_file_upload}</small>			
							...
							<input type="file" style="width:350px;" name="file{idelement}_upload[]"  onchange="$(\'#btn_save_back\').remove();"/>
    				</td>    			
    			</tr>
    	...
    	<div style="width:350px;float:right;">
    		...
    		<table cellspacing="0" cellpadding="0" border="0" width="100%">
    			...
    			<tr>
    				<td style="padding-bottom:15px;">
    					<input type="text" style="width:350px;" id="file1_title{idelement}" name="artel[file][title][]" value="{file1_title}"  onchange="previewfile(document.getElementById(\'file{idelement}\').value,\'{htmlpath}\',\'\',\'{idelement}\');"/>
    					<span style="display:{showhide_desc}">
	    					<small style="display:block;padding:5px 0 2px 0">{lng_file1_description}</small>
	    					<textarea style="width:350px;display:block;" id="file1_desc{idelement}" name="artel[file][description][]" value="" >{file1_description}</textarea>
							</span>
    				</td>
    			</tr>    		
    		</table>
...
$_AS['tpl']['linksub'] = '
    	...
    	<div style="width:350px;float:right;">
    		<table cellspacing="0" cellpadding="0" border="0" width="100%">
    			...
    			<tr>
    				<td style="padding-bottom:15px;">
    					<input type="text" style="width:350px;" id="link_title{idelement}" name="artel[link][title][]" value="{link_title}"  onchange="previewlink(document.getElementById(\'link_value_txt{idelement}\').value,\'{idelement}\');"/>
    					<span style="display:{showhide_desc}">
	    					<small style="display:block;padding:5px 0 2px 0">{lng_link_description}</small>
	    					<textarea style="width:350px;display:block;" id="link_desc{idelement}" name="artel[link][description][]" value="" >{link_description}</textarea>
							</span>
    				</td>
    			</tr>    		
    		</table>
...
$_AS['tpl']['datesub'] = '
    		...
    		<table cellspacing="0" cellpadding="0" border="0" width="100%">
    			...
    			<tr>
    			  <td width="20" align="center" style="padding-top:3px;">
    				...
    				<td>
							<input type="text" id="date{idelement}_day" maxlength="2" value="{date_day}" onchange="setdate(\'date\',\'{idelement}\');"  style="width:25px;text-align:center;"/>.&nbsp;
			    		<input type="text" maxlength="2" id="date{idelement}_month" value="{date_month}" onchange="setdate(\'date\',\'{idelement}\');"  style="width:25px;text-align:center;"/>.&nbsp;
			    		<input type="text" maxlength="4" id="date{idelement}_year" value="{date_year}" onchange="setdate(\'date\',\'{idelement}\');"  style="width:40px;text-align:center;"/>&nbsp;
    				...
    				<td colspan="3">
    					<span style="display:{showhide_time}">
	    					<small style="display:block;padding:5px 0 2px 0">{lng_date_time}</small>
								<input type="text" id="date{idelement}_hour" maxlength="2" value="{date_hour}" onchange="settime(\'date\',\'{idelement}\');"  style="width:25px;text-align:center;"/>:&nbsp;
				    		<input type="text" maxlength="2" id="date{idelement}_minute" value="{date_minute}" onchange="settime(\'date\',\'{idelement}\');"  style="width:25px;text-align:center;"/>
    	...
    	<div style="width:550px;float:right;">
    		<table cellspacing="0" cellpadding="0" border="0" width="100%">
    			...
    			<tr>
    				<td style="padding-bottom:15px;">
    					<input type="text" style="width:550px;" id="date_title{idelement}" name="artel[date][title][]" value="{date_title}"  onchange="previewdate(document.getElementById(\'date_value_txt{idelement}\').value,\'{idelement}\');"/>
    					<span style="display:{showhide_desc}">
	    					<small style="display:block;padding:5px 0 2px 0">{lng_date_description}</small>
	    					<textarea style="width:550px;height:53px;display:block;" id="date_desc{idelement}" name="artel[date][description][]" value="" >{date_description}</textarea>
							</span>
    				</td>
    			</tr>    		
    		</table>
...
for ($i=1;$i<51;$i++) {
	...
	$_AS['tpl']['custom'.$i] = '
	<tr id="row_custom'.$i.'">
	    <td width="150" class="head" {css_titlecell}><strong>{lng_custom'.$i.'}</strong>&nbsp;</td>
	    <td valign="top"><input type="text" class="w800" id="custom'.$i.'" name="article[custom'.$i.']" value="{custom'.$i.'}"  {readonly}></td>
    <td style="font-size:1px;"><div id="error_text__empty" style="display:{validation_error_cssdisplay};"><img src="{path}img/{validation_icon}" alt="{error_empty}" title="{error_empty}"></div>&nbsp;</td>
	...
	<tr id="row_custom'.$i.'">
	    <td width="150" class="head" {css_titlecell}><strong>{lng_custom'.$i.'}</strong>&nbsp;</td>
	    <td valign="top"><textarea {wysiwyg} id="custom'.$i.'" name="article[custom'.$i.']"  rows="8" class="w800" {readonly}>{custom'.$i.'}</textarea></td>
    <td style="font-size:1px;"><div id="error_text__empty" style="display:{validation_error_cssdisplay};"><img src="{path}img/{validation_icon}" alt="{error_empty}" title="{error_empty}"></div>&nbsp;</td>
	...
	<tr id="row_custom'.$i.'">
	    <td width="150" class="head" {css_titlecell}><strong>{lng_custom'.$i.'}</strong>&nbsp;</td>
	    <td><input type="text" id="custom'.$i.'_day" maxlength="2" value="{custom'.$i.'_day}" onchange="setdate(\'custom\','.$i.');"  style="width:25px;text-align:center;"/>.&nbsp;
	    		<input type="text" maxlength="2" id="custom'.$i.'_month" value="{custom'.$i.'_month}" onchange="setdate(\'custom\','.$i.');"  style="width:25px;text-align:center;"/>.&nbsp;
	    		<input type="text" maxlength="4" id="custom'.$i.'_year" value="{custom'.$i.'_year}" onchange="setdate(\'custom\','.$i.');"  style="width:40px;text-align:center;"/>&nbsp;
	...
	<tr id="row_custom'.$i.'">
	    <td width="150" class="head" {css_titlecell}><strong>{lng_custom'.$i.'}</strong>&nbsp;</td>
	    <td><input {readonly} type="text" id="custom'.$i.'_day" maxlength="2" value="{custom'.$i.'_day}" onchange="setdatetime(\'custom\','.$i.');"  style="width:25px;text-align:center;"/>.&nbsp;
	    		<input {readonly} type="text" maxlength="2" id="custom'.$i.'_month" value="{custom'.$i.'_month}" onchange="setdatetime(\'custom\','.$i.');"  style="width:25px;text-align:center;"/>.&nbsp;
	    		<input {readonly} type="text" maxlength="4" id="custom'.$i.'_year" value="{custom'.$i.'_year}" onchange="setdatetime(\'custom\','.$i.');"  style="width:40px;text-align:center;"/>&nbsp;
	    		...
	    		<input {readonly} type="text" id="custom'.$i.'_hour" maxlength="2" value="{custom'.$i.'_hour}" onchange="setdatetime(\'custom\','.$i.');"  style="width:25px;text-align:center;"/>:&nbsp;
	    		<input {readonly} type="text" maxlength="2" id="custom'.$i.'_minute" value="{custom'.$i.'_minute}" onchange="setdatetime(\'custom\','.$i.');"  style="width:25px;text-align:center;"/>
	    		<input type="hidden" id="custom'.$i.'" name="article[custom'.$i.']" value="{custom'.$i.'}">
					<script type="text/javascript" charset="utf-8">
					/* <![CDATA[ */
						$(function() {
	...
	<tr id="row_custom'.$i.'">
	    <td width="150" class="head" {css_titlecell}><strong>{lng_custom'.$i.'}</strong>&nbsp;</td>
	    <td><input type="text" id="custom'.$i.'_hour" maxlength="2" value="{custom'.$i.'_hour}" onchange="settime(\'custom\','.$i.');"  style="width:25px;text-align:center;"/>:&nbsp;
	    		<input type="text" maxlength="2" id="custom'.$i.'_minute" value="{custom'.$i.'_minute}" onchange="settime(\'custom\','.$i.');"  style="width:25px;text-align:center;"/>
...
$_AS['tpl']['buttons'] = '
<tr id="row_buttons">
    <td width="150" class="head" {css_titlecell}>&nbsp;</td>
...
<tr id="row_picture1">
    <td width="150" class="head" {css_titlecell}>
	    			<strong>{lng_pictures}</strong>
    </td>
    <td valign="top" style="padding-right:8px;">
			{picture1sub}
...
$_AS['tpl']['custom_picture_sub'] = '
    			...
    			<tr style="display:{showhide_upload}">
    				...
    				<td colspan="2">
    					<small style="display:block;padding:4px 0 2px 0">{lng_picture_upload}</small>			
							...
							<input type="file" style="width:350px;" name="{custom_field}_upload[]"  onchange="$(\'#btn_save_back\').remove();"/>
    				</td>    			
    			</tr>
    	...
    	<div style="width:350px;float:right;">
    		...
    		<table cellspacing="0" cellpadding="0" border="0" width="100%">
    			...
    			<tr>
    				<td style="padding-bottom:15px;">
    					<input type="text" style="width:350px" id="picture1_title{idelement}" name="article[{custom_field}_title]" value="{custom_field_title_value}"  onchange="set_custom_pic(\'{custom_field}\',\'{idelement}\');"/>
    					<span style="display:{showhide_desc}">
	    					<small style="display:block;padding:5px 0 2px 0">{lng_picture1_description}</small>
	    					<textarea style="width:350px;display:block;" id="picture1_desc{idelement}" name="article[{custom_field}_desc]"  onchange="set_custom_pic(\'{custom_field}\',\'{idelement}\');">{custom_field_desc_value}</textarea>
							</span>
    				</td>
    			</tr>    		
    		</table>
...
$_AS['tpl']['custom_file_sub'] = '
    	...
    	<div style="width:350px;float:right;">
    		<table cellspacing="0" cellpadding="0" border="0" width="100%">
    			...
    			<tr>
    				<td style="padding-bottom:15px;">
    					<input type="text" style="width:350px;" id="file1_title{idelement}" name="article[{custom_field}_title]" value="{file1_title}"  onchange="previewfile(document.getElementById(\'file{idelement}\').value,\'{htmlpath}\',\'\',\'{idelement}\');set_custom_file(\'{custom_field}\',\'{idelement}\');"/>
    					<span style="display:{showhide_desc}">
	    					<small style="display:block;padding:5px 0 2px 0">{lng_file1_description}</small>
	    					<textarea style="width:350px;display:block;" id="file1_desc{idelement}" name="article[{custom_field}_desc]" value=""  onchange="set_custom_file(\'{custom_field}\',\'{idelement}\');">{file1_description}</textarea>
							</span>
    				</td>
    			</tr>    		
    		</table>
    			  ...
    			  <td width="20" align="center" style="padding-top:3px;">
    				...
    				<td align="right">
			    		<button type="button" style="font-family:verdana;font-size:10px;width:25px;margin-right:5px;" onclick="if (confirmreset()) {clear_link(\'{idelement}\');set_custom_link(\'{custom_field}\',\'{idelement}\');}">C</button>
							<button type="button" style="font-family:verdana;font-size:10px;width:25px;" onclick="rbidelement=\'{idelement}\';customfield=\'{custom_field}\';new_window(\'{rb_link_url}\', \'rb\', \'\', screen.width * 0.6, screen.height * 0.6, \'true\');;set_custom_link(\'{custom_field}\',\'{idelement}\');">...</button>
    				</td>
    			</tr>
    			<tr>
    				<td colspan="2" width="25" align="right">&nbsp;</td>
    			...
    			<tr>
    				<td style="padding-bottom:15px;">
    					<span style="display:{showhide_title}">
	    					<input type="text" style="width:350px;" id="link_title{idelement}" name="article[{custom_field}_title]" value="{link_title}"  onchange="previewlink(document.getElementById(\'link_value_txt{idelement}\').value,\'{idelement}\');set_custom_link(\'{custom_field}\',\'{idelement}\');"/>
							</span>
    					<span style="display:{showhide_desc}">
	    					<small style="display:block;padding:5px 0 2px 0">{lng_link_description}</small>
	    					<textarea style="width:350px;display:block;" id="link_desc{idelement}" name="article[{custom_field}_desc]" value=""  onchange="set_custom_link(\'{custom_field}\',\'{idelement}\');">{link_description}</textarea>
							</span>
    				</td>
    			</tr>    		
    		</table>
